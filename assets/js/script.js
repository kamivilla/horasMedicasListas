...
// titulo
document.getElementById('titulo').innerHTML = "Centro médico ñuñoa";

/** Elimina primer y último elemento **/
radiologia.shift();
radiologia.pop();


/** Lista dental **/
document.getElementById("titulo_listadoDental").innerHTML = "Listado dental: ";

let dentista = document.getElementById("dental");

dental.forEach(function (datos) {
    dentista.innerHTML += `${[datos.hora, datos.especialista, datos.paciente, datos.rut, datos.prevision].join(" - ")} <br><br>`;
});

/** Listado pacientes */
document.getElementById("titulo_listadoTotal").innerHTML = "Listado total de pacientes: ";

let total = document.getElementById("listaPacientes");
var concatenar = radiologia.concat(traumatologia, dental);
concatenar.forEach(function (all) {
    total.innerHTML += (`<li> ${all.paciente}.</li><br>`);
});

/** Filtro pacientes dental Isapre*/
document.getElementById("titulo_pacientesIsapre").innerHTML = "Pacientes Isapre de Dental";
